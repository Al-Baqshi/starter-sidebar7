...
import { FileIcon, DownloadIcon, MessageSquare, Award, Clock, Users } from 'lucide-react'
...
const mockBid: Bid = {
  ...
  attachments: [
    { id: "A1", name: "Detailed Cost Breakdown", type: "pdf", url: "/placeholder.svg?height=300&width=300" },
    { id: "A2", name: "Project Timeline", type: "pdf", url: "/placeholder.svg?height=300&width=300" },
    { id: "A3", name: "Equipment List", type: "xlsx", url: "/placeholder.svg?height=300&width=300" },
    { id: "A4", name: "Team Qualifications", type: "docx", url: "/placeholder.svg?height=300&width=300" },
  ],
  laborInfo: {
    numberOfStaff: 15,
  ...
  return (
    <Card className="w-full">
      <CardContent className="p-4 flex flex-col items-center">
        ...
        <p className="text-sm font-medium mb-2 text-center">{attachment.name}</p>
        <p className="text-xs text-muted-foreground mb-2">{attachment.type.toUpperCase()}</p>
...
export default function ProposalPage({ params }: { params: { id: string, bidId: string } }) {
  ...
  return (
    <div className="container space-y-6 p-8">
      <div className="flex justify-between items-center">
        <Button variant="outline" onClick={() => router.back()}>Back to Tender</Button>
        <Button onClick={handleAward} className="bg-green-500 hover:bg-green-600">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center space-x-4">
              <Avatar className="h-10 w-10">
                <AvatarImage src={bid.bidderDetails.avatar} alt={bid.bidderDetails.name} />
                <AvatarFallback>{bid.bidderDetails.name[0]}</AvatarFallback>
              </Avatar>
              <div>
                <p className="font-semibold">{bid.bidderDetails.name}</p>
                <p className="text-sm text-muted-foreground">{bid.bidderDetails.company}</p>
              </div>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-2xl font-bold">${bid.bidAmount.toLocaleString()}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{bid.laborInfo.numberOfStaff}</p>
              </div>
              <div>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Bidder Contact Information</h3>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>
                    <a href={`tel:${bid.bidderDetails.phone}`} className="text-blue-500 hover:underline">
              ...
              <div className="mt-4">
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Contact {bid.bidderDetails.name}</DialogTitle>
                      <DialogDescription>
