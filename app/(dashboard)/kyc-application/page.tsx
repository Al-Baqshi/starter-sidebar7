...
const formSchema = z.object({
  ...
  nzbn: z
    .string()
    .min(13, { message: "NZBN must be 13 digits." })
    .max(13)
    .optional(),
  companyAddress: z
    .string()
  ...
  directorName: z
    .string()
    .min(2, { message: "Director's name must be at least 2 characters." })
    .optional(),
  businessType: z
    .enum(["sole_trader", "partnership", "limited_company", "trust"])
    .optional(),
});
  ...
  function onSubmit(values: any) {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "Your KYC/KYB application has been submitted successfully.",
      });
    }, 2000);
  }
    ...
    <div className="container mx-auto py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Please select your application type and fill out the form below.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <RadioGroup
            className="mb-6"
            onValueChange={(value) =>
              setApplicationType(value as "individual" | "business")
            }
          >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {field.value
                          ? `Upload ${form.getValues("idType")} Document`
                          : "Upload ID Document"}
                      </FormLabel>
                      <FormControl>
                        <Input
                      ...
                      <FormDescription>
                        Please upload a clear, legible copy of your selected ID
                        document.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
